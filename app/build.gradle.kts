...
android {
    ...
    bundle {
        // Мову перемикає сам застосунок, тому всі локалі мають лежати в базовому APK.
        // Зі спліт-доставкою Play віддає лише ті, що збігаються з системними локалями,
        // і на пристрої без української вибір мови в налаштуваннях нічого не змінює.
        language {
            enableSplit = false
        }
    }
...
dependencies {
    ...
    implementation(project(":data:survey"))
