...
import com.kovhan.feature.survey.navigation.SurveyDialogEntryBuilder
...
abstract class DialogNavigationModule {
    ...
    @Binds
    @IntoSet
    abstract fun bindSplashDialogEntryBuilder(
        impl: SplashDialogEntryBuilder,
    ): DialogEntryBuilder

    @Binds
    @IntoSet
    abstract fun bindSurveyDialogEntryBuilder(
        impl: SurveyDialogEntryBuilder,
    ): DialogEntryBuilder
}
