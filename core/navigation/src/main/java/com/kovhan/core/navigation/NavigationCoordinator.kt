...
class NavigationCoordinator @Inject constructor() {
    ...
    companion object {
        ...
        const val KEY_DAILY_QUOTE_KEEP = "daily_quote_keep"
        ...
        const val KEY_UPDATE_REQUIRED_UPDATE = "update_required_update"
        const val KEY_UPDATE_REQUIRED_EXIT = "update_required_exit"
