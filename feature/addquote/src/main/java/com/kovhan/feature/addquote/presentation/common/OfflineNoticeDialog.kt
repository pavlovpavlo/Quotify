...
/** Small "you're offline, this feature needs internet" notice for AI actions. */
@Composable
internal fun OfflineNoticeDialog(onDismiss: () -> Unit) {
    ...
    QuotifyDialog(onDismissRequest = onDismiss) {
        Column(
            ...
            QuotifyButton(
                text = stringResource(R.string.ai_offline_ok),
                onClick = onDismiss,
