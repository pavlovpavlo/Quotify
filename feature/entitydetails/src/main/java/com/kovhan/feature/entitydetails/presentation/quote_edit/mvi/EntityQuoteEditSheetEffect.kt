...
sealed interface EntityQuoteEditSheetEffect : UiEffect {
    data class OpenTagSheet(
        val quoteText: String,
        val selectedTags: List<String>,
        val aiTags: List<String>,
        val tagPool: List<String>,
    ) : EntityQuoteEditSheetEffect

    data class CloseWithResult(val draft: EntityQuoteDraft) : EntityQuoteEditSheetEffect
}
